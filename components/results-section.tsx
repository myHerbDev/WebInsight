                    ...
                    <div className="relative w-40 h-40 flex items-center justify-center">
                      <svg className="w-full h-full" viewBox="0 0 100 100">
                        ...
                        <circle
                          ...
                          strokeDashoffset={251.2 - (251.2 * data.sustainability.score) / 100}
                          strokeLinecap="round"
                          stroke="currentColor"
                          fill="transparent"
                          r="40"
                      ...
                      <div className="absolute text-3xl font-bold">{data.sustainability.score}</div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      <div className="flex justify-between mb-1">
                        ...
                        <span>{data.sustainability.performance}%</span>
                      </div>
                      <Progress value={data.sustainability.performance} />
                    </div>
                    <div>
                      <div className="flex justify-between mb-1">
                        <span>Script Optimization</span>
                        <span>{data.sustainability.scriptOptimization}%</span>
                      </div>
                      <Progress value={data.sustainability.scriptOptimization} />
                    </div>
                    <div>
                      <div className="flex justify-between mb-1">
                        <span>Duplicate Content</span>
                        <span>{data.sustainability.duplicateContent}%</span>
                      </div>
                      <Progress value={data.sustainability.duplicateContent} />
                    </div>
                  </div>
                </CardContent>
              </Card>
                  ...
                  <ul className="space-y-3">
                    {data.sustainability.improvements.map((improvement, index) => (
                      <li key={index} className="flex items-start p-3 border rounded-lg">
                        <div className="w-6 h-6 rounded-full bg-teal-100 text-teal-800 dark:bg-teal-900 dark:text-teal-200 flex items-center justify-center mr-3">
                          {index + 1}
                        </div>
